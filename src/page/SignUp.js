      ...
      <div className="max-w-sm w-full m-auto bg-white p-4">
        <div className="overflow-hidden drop-shadow-md shadow-md p-1 pb-3 ">
          <label htmlFor="xx">
            <div className="border-8 overflow-hidden drop-shadow-md shadow-md m-auto flex  justify-center items-center relative  rounded-full w-[100px] h-[100px]">
              <img
                src={data.image ? data.image : signLogo}
                alt="fsf"
            ...
            <input
              type={"file"}
              accept="image/*"
              className="absolute hidden bottom-0"
              id="xx"
        ...
        >
          ...
          <input
            ...
            name="firstname"
            id="firstname"
            className=" focus-within:outline-blue-200 text-sm mb-1 bg-zinc-200 px-2 py-1 mt-1 rounded"
          />
          ...
          <input
            ...
            className=" focus-within:outline-blue-200 text-sm mb-1 rounded bg-zinc-200 px-2 py-1 mt-1"
          />
          ...
          <div className="bg-zinc-200 my-1 px-2 py-1  rounded flex items-center ">
            ...
            />
            <span className="" onClick={showPass}>
          ...
          <div className="my-1 px-2 py-1 bg-zinc-200 rounded flex items-center">
            <input
              ...
              className=" bg-zinc-200   focus-within:outline-none w-full"
            />
            <span className="" onClick={showConPassword}>
              {showConPass ? <BiShow /> : <BiHide />}
            </span>
          </div>
          <button
            type={"submit"}
            className="m-auto bg-blue-600 my-1 border w-[105px] rounded-2xl mt-2 font-serif text-white hover:bg-green-600 shadow-md px-2 py-1"
          >
            Sign Up
          </button>
        </form>
